...
int parse_reg_immediate (char* imme, char* instr_bin_str); // EC Q2: I tried my best, but only partially succeed in dealing with ADD immediate, since it can only accept positive decimal like #2, #5
